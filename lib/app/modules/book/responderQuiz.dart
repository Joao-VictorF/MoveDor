...
class ResponderQuiz extends StatefulWidget {
  @override
  State createState() => new ResponderQuizState();
  ...
  createQuestions(BuildContext ctx) {
    ...
    questoes.add(
      new Questao(
        ...
        questao: {
          ...
          'check_yes': false,
          'check_no': false,
          'msg': 'A dor lombar é uma queixa comum! Em torno de 84% da população brasileira irá sentir a DL em algum momento da vida.',
        },
        onValueChange: _onValueChange,
      )
    );
    ...
    questoes.add(
      new Questao(
        ...
        answerController: answersControllers[2],
        questao: {
          'enunciado': 'Sentir dor nas costas durante um exercício é normal, contanto que ela não aumente ou continue depois da atividade?',
          'correct': 0,
          'its_true': true,
          'check_yes': false,
          'check_no': false,
          'msg': 'A dor pode acontecer durante a atividade, mas não deve se manter nem aumentar após sua conclusão. Ao se sentir seguro, progrida aos poucos, até ganhar confiança para fazer o movimento livremente.',
        },
        onValueChange: _onValueChange,
      )
    );
    ...
    questoes.add(
      new Questao(
        ...
        questao: {
          ...
          'check_yes': false,
          'check_no': false,
          'msg': 'Ficar apenas em repouso ou receber tratamentos passivos não irão melhorar a sua dor. Viver em movimento sim! Na verdade, o movimento é um dos maiores aliados no tratamento da dor lombar!',
        },
        onValueChange: _onValueChange,
      )
    );
    ...
    questoes.add(
      new Questao(
        ...
        questao: {
          ...
          'check_yes': false,
          'check_no': false,
          'msg': 'A caminhada é um exercício simples, gratuito, de baixo impacto físico e com ganhos importantes para pessoas com dor crônica. Você nunca caminhou ou não faz nenhum exercício físico? Comece aos poucos.',
        },
        onValueChange: _onValueChange,
      )
    );
    ...
    questoes.add(
      new Questao(
        ...
        questao: {
          ...
          'check_yes': false,
          'check_no': false,
          'msg': 'Você não precisa iniciar pelo movimento mais desafiador! Procure por movimentos mais fáceis e simples, sempre respeitando os limites do seu corpo e, conforme for se sentindo seguro(a), progrida aos poucos, até ganhar mais confiança!',
        },
        onValueChange: _onValueChange,
      )
    );
    ...
    questoes.add(
      new Questao(
        ...
        answerController: answersControllers[4],
        questao: {
          'enunciado': 'Exercícios de relaxamento irão ajudar no controle da Dor Lombar?',
          'correct': 0,
          'its_true': false,
          'check_yes': false,
          'check_no': false,
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          RaisedButton(
                            child: new Text("Concluir capítulo", style: TextStyle(color: Colors.white)),
                      ...
                      Column(
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              new RaisedButton(
                                child: new Text("Não", style: TextStyle(color: Colors.white)),
