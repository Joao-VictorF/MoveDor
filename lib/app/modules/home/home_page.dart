      ...
      builder: (_) {
        return
          Scaffold(
            ...
            //               )
            //             ),
            //           activeIcon: Icon(CustomIcons.book, color: Colors.blueAccent),
            //         ),
            //         BubbleBottomBarItem(
            //           icon: Icon(
            ...
            //                 Colors.white70
            //                 :
            //                 Colors.redAccent[200].withOpacity(.9)
            //               )
            //             ),
            //           activeIcon: Icon(Icons.chrome_reader_mode, color: Colors.redAccent[100],),
            //         ),
            //         BubbleBottomBarItem(
            //           icon: Icon(
            //             Icons.description,
            //             color: Color.fromRGBO(111, 146, 99, 1),
            //           ),
            //           backgroundColor: Color.fromRGBO(111, 146, 99, 1),
            //           title: Text("Sobre o app",
            //             style: TextStyle(
            //             color: appState.isDarkMode ? 
            //               Colors.white70
            //               :
            //               Color.fromRGBO(111, 146, 99, 1)
            //             )
            //           ),
