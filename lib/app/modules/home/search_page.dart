...
class _SearchPageState extends State<SearchPage> {
  ...
  Map<String, bool> frases = {
    ...
    'Mudo de posição frequentemente tentando deixar minhas costas confortáveis.' : false,
    'Ando mais devagar que o habitual por causa de minhas costas.' : false,
    'Por causa de minhas costas, eu não estou fazendo nenhum dos meus trabalhos que geralmente faço em casa.' : false,
    'Por causa de minhas costas, eu uso o corrimão para subir escadas.' : false,
    'Por causa de minhas costas, eu me deito para descansar mais frequentemente.' : false,
    'Por causa de minhas costas, eu tenho que me apoiar em alguma coisa para me levantar de uma cadeira normal.' : false,
    'Por causa de minhas costas, tento conseguir com que outras pessoas façam as coisas para mim.' : false,
    'Eu me visto mais lentamente que o habitual por causa de minhas costas.' : false,
    'Eu somente fico em pé por períodos curtos de tempo por causa de minhas costas.' : false,
    'Por causa de minhas costas, evito me abaixar ou me ajoelhar.' : false,
    'Encontro dificuldades em me levantar de uma cadeira por causa de minhas costas.' : false,
    ...
    'Tenho problemas para colocar minhas meias (ou meia-calça) por causa das dores em minhas costas.' : false,
    'Caminho apenas curtas distâncias por causa de minhas dores nas costas.' : false,
    'Não durmo tão bem por causa de minhas costas.' : false,
    'Por causa de minhas dores nas costas, eu me visto com ajuda de outras pessoas.' : false,
    ...
    'Por causa das dores em minhas costas, fico mais irritado e mal humorado com as pessoas que o habitual.' : false,
    'Por causa de minhas costas, eu subo escadas mais vagarosamente do que o habitual.' : false,
  ...
  Map<String, bool> startBackFrases = {
    'A minha dor nas costas se espalhou pelas pernas nas duas útlimas semanas.' : false,
    'Eu tive dor no ombro e/ou pelo menos uma vez nas duas útlimas semanas.' : false,
    'neu evito andar longas distâncias por causa da minha dor nas costas.' : false, 
    'Nas duas útlimas semanas, tenho me vestido mais devagar por causa da minha dor nas costas.' : false, 
    'A atividade física não é realmente segura para uma pessoa com um problema como o meu.' : false, 
    'Tenho ficado preocupado por muito tempo por causa da minha da minha dor nas costas.' : false, 
    'Eu sinto que minha dor nas costas é terrível e que nunca vai melhorar' : false , 
    'Em geral, eu não tenho gostado de todas as coisas como eu costumava gostar.' : false, 
  };
                ...
                Container (
                  ...
                  RichText(
                    ...
                    text: new TextSpan(
                      ...
                      children: <TextSpan>[
                        new TextSpan(text:  '''Esse app é voltado para pessoas com Dor Lombar Crônica!
Antes de iniciarmos, gostaríamos de fazer algumas perguntas para que possamos te conhecer melhor, pode ser? '''),
                        new TextSpan(text: '😁', style: new TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'MontserratBold')),
                      ],
                    ),
                  ),
                ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        enabledBorder: 
                        OutlineInputBorder(      
                          borderSide: BorderSide(color: appState.isDarkMode ? Colors.white70 : Colors.black45,),   
                        ),
                        focusedBorder: 
                        OutlineInputBorder(      
                          borderSide: BorderSide(color: appState.isDarkMode ? Colors.white70 : Colors.black45,),   
                        ...
                        labelStyle: TextStyle(
                          fontFamily: 'MontserratRegular',
                          color: appState.isDarkMode ? Colors.white70 : Colors.black45,
                        )
                      ...
                      onTap: () {
                        DatePicker.showDatePicker(
                          ...
                          onConfirm: (date) {
                            ...
                            setState(() {
                              nascimento = "${newData[2]}/${newData[1]}/${newData[0]}";
                            });
                          },
                  ...
                  Container (
                    ...
                    Text(
                      ...
                      TextStyle(
                        fontFamily: 'MontserratRegular',
                        color: appState.isDarkMode ? Colors.white70 : Colors.black54,
                        fontSize: appState.fontSize.toDouble() + 6,
                      ),
                    ),
                  ),
                        ...
                        CheckboxListTile(
                          ...
                          onChanged: (bool value) {
                            if(key == 'Não pratico atividades físicas' && value) {
                              setState(() {
                                selectedSports = [];
                                searchSportQuestions['Caminhar com os amigos'] = false;
              ...
              Column(
                ...
                Container(
                  ...
                  Slider(
                    ...
                    activeColor: sliderValue.toInt() > 8 ? Colors.red : sliderValue.toInt() > 5 ? Colors.red[300] : sliderValue.toInt() > 3 ? Colors.green[300] : Colors.green,
              ...
              Column(
                ...
                Container(
                  ...
                  Slider(
                    ...
                    inactiveColor: Colors.green[50],
                    activeColor: startBackSliderValue.toInt() > 3 ? Colors.red : startBackSliderValue.toInt() < 2 ? Colors.green : Colors.red[300],
                    onChanged: (double value) {
                      setState(() {
                        value == 0 ?
                        ...
                        :
                          startBackSliderLabel = 'Extremamente';
                ...
                Container (
                  ...
                  RichText(
                    ...
                    text: new TextSpan(
                      ...
                      children: <TextSpan>[
                        new TextSpan(text: 'Muito obrigado, ${nomeController.text}'),
                      ],
                    ),
                  ),
                ),
