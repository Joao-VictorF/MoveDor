              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    enabledBorder: 
                    OutlineInputBorder(      
                      borderSide: BorderSide(color: isDarkMode ? Colors.white70 : Colors.black45,),   
                    ),
                    focusedBorder: 
                    OutlineInputBorder(      
                      borderSide: BorderSide(color: isDarkMode ? Colors.white70 : Colors.black45,),   
                      ...
                      if(!alertaDeRiscoMostrado) {
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return 
                            RichAlertDialog( 
                              alertTitle: richTitle("Esses sintomas\nmerecem atenção."),
                              alertSubtitle: richSubtitle("Busque um atendimento médico."),
